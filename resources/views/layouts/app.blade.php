            ...
            <div class="row align-center">
                <div class="col-lg-9">
                    <div class="flex-item left">
                        <p>
                            That's right, we promote agricultural excellence
                        </p>
                        <ul>
                            <li>
                                <i class="fas fa-map-marker-alt"></i> Umuaroko Ndume Ibeku, Umuahia, Abia state, Nigeria.
                            </li>
                                ...
                                <li class="contact">
                                    <div class="call">
                                        ...
                                        <div class="info">
                                            ...
                                            <h5><a href="mailto:info@udonyenweakufarm.com">info@udonyenweakufarm.com</a></h5>
                                        </div>
                                    </div>
                                </li>
                            </ul>
    ...
    <footer class="bg-dark text-light" style="background-image: url(assets/img/shape/brush-down.png);">
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 item">
                        <div class="footer-item about">
                            <img class="logo" src="{{asset('/')}}assets/img/logo-lightt.png" alt="Logo">
                            <p>
                                Ud-onyenweaku Farm Complex: Cultivating Excellence, Nurturing Communities, Sustaining Nature
                            <form action="#">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="content">
                                        ...
                                        Uchenna Onyenweaku compound, Umuaroko Ndume Ibeku, Umuahia, Abia state, Nigeria.
                                    </div>
                                </li>
                                <li>
                                    <div class="icon">
                                    ...
                                    <div class="content">
                                        <strong>Email:</strong>
                                        <a href="mailto:info@udonyenweakufarm.com">info@udonyenweakufarm.com</a>
                                    </div>
                                </li>
                                {{-- <li>
                                    <div class="icon">
            ...
            <div class="footer-bottom">
                <div class="row">
                    <div class="col-lg-6">
                        <p>&copy; Copyright {{\Carbon\Carbon::now()->year}}. All Rights Reserved</p>
                    </div>
